...
func (ec *executionContext) field_Mutation_createAccount_argsAccount(
	...
	if tmp, ok := rawArgs["account"]; ok {
		return ec.unmarshalNAccountInput2githubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐAccountInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_createOrder_argsOrder(
	...
	if tmp, ok := rawArgs["order"]; ok {
		return ec.unmarshalNOrderInput2githubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐOrderInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_createProduct_argsProduct(
	...
	if tmp, ok := rawArgs["product"]; ok {
		return ec.unmarshalNProductInput2githubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐProductInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Query_accounts_argsPagination(
	...
	if tmp, ok := rawArgs["pagination"]; ok {
		return ec.unmarshalOPaginationInput2ᚖgithubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐPaginationInput(ctx, tmp)
	}
...
func (ec *executionContext) _Account_orders(ctx context.Context, field graphql.CollectedField, obj *Account) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖgithubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputOrderInput(ctx context.Context, obj interface{}) (OrderInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "products":
			...
			data, err := ec.unmarshalOOrderProductInput2ᚕᚖgithubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐOrderProductInput(ctx, v)
			if err != nil {
				return it, err
			}
			it.Products = data
...
func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐOrder(ctx context.Context, sel ast.SelectionSet, v []*Order) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOOrder2ᚖgithubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) unmarshalOOrderProductInput2ᚕᚖgithubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐOrderProductInput(ctx context.Context, v interface{}) ([]*OrderProductInput, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []interface{}
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalOOrderProductInput2ᚖgithubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐOrderProductInput(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalOOrderProductInput2ᚖgithubᚗcomᚋsallescostaᚋfullProjectᚋgraphqlᚐOrderProductInput(ctx context.Context, v interface{}) (*OrderProductInput, error) {
	if v == nil {
		return nil, nil
	}
